var TinyReact = (() => {
  ...
  //   const updateProps = function(target, oldProps, newProps) {};

  //   const updateProp = function(element, oldProp, newProp) {
  //     if (!newProp) {
  //       //Remove
  //       if (/^on/.test(oldProp.name)) {
  //         //event
  //         var eventName = oldProp.name.slice(2).toLowerCase();
  //         element.removeEventListener(eventName, eventProxy, false);
  //       } else {
  //         //attribute
  //         element.removeAttribute(name, props[name]);
  //       }
  //     }
  //   };
