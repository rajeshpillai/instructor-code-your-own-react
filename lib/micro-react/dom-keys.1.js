var TinyReact = (function () {
    ...
    const diffList = (virtualElements, parentDomElement) => {
        ...
        virtualElements.forEach((virtualElement, i) => {
            ...
            if (key) {
                ...
                if (keyedDomElement) {
                    ...
                    createNewDomElement(virtualElement, parentDomElement, placeholder);
                }
            } else {
        ...
        // let oldDomChilds = parentDomElement.childNodes;
        // if (oldDomChilds.length > virtualElements.length) {
        //     for(let i = oldDomChilds.length-1; i >= virtualElements.length; i--){
        //         oldDomChilds[i].remove();
        //     }
        // }
