var TinyReact = (function () {
    ...
    const diff = function (vdom, container, oldDom) {
        ...
        if (!oldVDom) {
            ...
            if (typeof vdom.type === 'function') {
                vdom = diffComponent(vdom, container, oldDom, oldVDom);
            }    
            else {
            ...
            //         childElement = diffComponent(childElement, container, oldDom, oldVDom);
            //     }    
            //     else {
            //         // Text node or dom elements
            //         if (childElement.type === "text") {
            //             updateTextNode(oldDom, childElement, oldVDom);
            //         } else {
            //             updateDomElement(oldDom, childElement, oldVDom);
            //         }
            //     }
            // });
    ...
    const diffComponent = function (vdom, container, oldDom, oldVDom) {
    ...
    const mountElement = function (vdom, container, oldDom = container.firstChild) {
        if (typeof vdom.type === 'function') {
