...
// 22. Testing
// 23. Add support for passing style attributes as objects
// 24. WIP:  createContext API
//     NOTES: 1. Basic context working 
//              (but diff needs to be optimized for items not changing) 
//Issue exist for diff rendering when consumer is not wrapped with div in Message component
//25: WP async setstate


const TinyReact = (function () {
    var compArrayToBeRemoved=[];
        ...
        if (!oldDom) {
            ...
            if (Object.keys(keyedElements).length === 0) {
                ...
                vdom.children.forEach((child, i) => {
                    console.log("child and childdom", child, oldDom.childNodes[i])
    ...
    function getKey(vdom) {
        return vdom.props && vdom.props.key;
    }
            ...
            if (newProp !== oldProp) {
                if (propName.slice(0, 2) === "on") {
                    ...
                    if (propName === "className") {
                        ...
                        // style is an object
                        let styleString = styleObjToCss(newProps[propName]);
                        domElement.style = styleString;
                    }
                    else {
    ...
    function jsToCss(s) {
        // Took this from old preact code base
        let transform = s.replace(/([A-Z])/, '-$1').toLowerCase();;
        return transform;
    }
    ...
    class Component {
        ...
        setState(nextState, callback) {
            // setTimeout(()=>{
                ...
                if(callback){
                    console.log("calback pushed ************************************")
                    this.renderCallbacks.push(callback);
                    compArrayToBeRemoved.push(this);
                }
                
                // while (this.renderCallbacks.length) this.renderCallbacks.pop().call();
                this.triggerRender();
               


                //this.enqueueRender(this);

            //     // this.renderCallbacks.forEach((a)=>{
        ...
        //     console.log("enqueueRender _dirty ************************************",this._dirty);
        //     if (this._dirty == true || (!this._dirty && (this._dirty = true))) {
        //         this.renderComponent();
        //         while (this.renderCallbacks.length) this.renderCallbacks.pop().call();
        //     }
        // }
        ...
        renderComponent(){
            ...
            // this._dirty = false;
            //while (this._renderCallbacks.length) this._renderCallbacks.pop().call();
        }
    ...
    function createContext(value) {
        ...
        class Provider extends Component {
            ...
            render() {
                //return this.props;
                return createElement("span", null, this.props.children);
            }
        }
        ...
        class Consumer extends Component {
            ...
            render() {
                ...
                console.log("Consumer::render", contextValue);
                // TODO: handle render props and render as children
                return this.props.children[0](this.state.value); // children is a function
                //return this.props.children[0](contextValue);

                //return createElement("div", null, this.props.children[0](this.state.value));
            }
        }
        return {
            Provider: Provider,
